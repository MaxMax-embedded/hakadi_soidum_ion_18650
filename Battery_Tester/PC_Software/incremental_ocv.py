...
OCV_DISCHARGE_STEP_WAIT = 900       #Wait time after the SoC was reduced in seconds
...
OCV_CHARGE_STEP_WAIT = 900          #Wait time after the SoC was increased in seconds
