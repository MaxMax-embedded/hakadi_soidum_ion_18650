...
logfile = "./static_test_1c-2-1.csv" #Path of the logfile for the experiment
...
comport = Serial.Serial(port="COM6",baudrate=115200)
logfile = "./static_test_0c75-2-1.csv" #Path of the logfile for the experiment
...
comport = Serial.Serial(port="COM6",baudrate=115200)
logfile = "./static_test_1c5-2-1.csv" #Path of the logfile for the experiment
...
comport = Serial.Serial(port="COM6",baudrate=115200)
logfile = "./static_test_2c-2-1.csv" #Path of the logfile for the experiment
